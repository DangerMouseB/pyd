...
import pyd.reboot.attributes : args, kwargs, pymagic;
...
export class Magic {
    ...
    @__slice__
    PyObject* slice(int from, int to, int stride) {
    ...
    @kwargs("kwargs")
    @magic("__call__")
    PyObject* sally(PyObject* args, PyObject* kwargs) {
        return d_to_python([args, kwargs]);
    }


    @__call__
    PyObject* sally(@args PyObject* args, @kwargs PyObject* kwargs) {
        return d_to_python([args, kwargs]);
    }
    ...
    @args("args")
    PyObject* fred(PyObject* args) {
        return d_to_python([args]);
    }

    @kwargs("kwargs")
    PyObject* joe(PyObject* kwargs) {
        return d_to_python([kwargs]);
    }
    ...
    PyObject* arthur(PyObject* p1, PyObject* p2, PyObject* p3) {
        return d_to_python([p1, p2, p3]);
    }
